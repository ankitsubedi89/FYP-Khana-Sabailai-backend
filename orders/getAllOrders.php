...
if (isset($_POST['restaurant_id'])) {
    ...
    $sql = "SELECT o.*, r.name as restaurant_name, r.contact as restaurant_contact, r.address as restaurant_address, u.name as user_name, u.address as user_address, u.contact as user_contact from orders o join restaurants r on r.id = o.restaurant_id join users u on o.user_id = u.id  order by o.date desc";
}
